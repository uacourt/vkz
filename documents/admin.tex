...
\fancyfoot[L]{\small\color{footergray} Інструкція користувача та адміністратора підсистеми ВКЗ ЄСІКС}
...
\begin{titlepage}
  ...
  {\Huge  \textbf{НАСТАНОВИ АДМІНІСТРАТОРА} \par} \vspace{1.5cm}
...
\midrule
\textbf{Назва документа} & Інструкція адміністратора підсистеми ВКЗ ЄСІКС \\
